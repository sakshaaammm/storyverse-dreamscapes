...
export const StoryScene = ({ 
  ...
  return (
    <Card className="overflow-hidden shadow-2xl transition-all duration-500 hover:shadow-[0_20px_50px_rgba(155,135,245,0.3)] transform hover:scale-105 bg-gradient-to-br from-[#1A1F2C] via-[#2A1F3C] to-[#000000e6]">
      {scene.image && (
        <div className="relative aspect-video">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#1A1F2C]/70 to-[#000000e6] backdrop-blur-sm" />
      ...
      <div className="p-6 bg-gradient-to-b from-[#1A1F2C] via-[#2A1F3C] to-[#000000e6]">
        <div
          ...
          <div className="space-y-4 animate-fade-in">
            {scene.choices.map((choice: Choice, index: number) => (
              <Button
                ...
                className="w-full justify-start bg-[#1A1F2C] text-[#9b87f5] hover:bg-[#9b87f5] hover:text-white transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-[#9b87f5]/50 border border-[#9b87f5]/20"
                variant="outline"
              >
                {choice.text}
              </Button>
