    ...
    <Card className="overflow-hidden shadow-2xl transition-all duration-500 hover:shadow-[0_20px_50px_rgba(155,135,245,0.3)] transform hover:scale-105 bg-gradient-to-br from-black via-[#2A1F3C] to-[#1A1F2C]">
      {scene.image && (
        <div className="relative aspect-video">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-black/70 to-[#1A1F2C] backdrop-blur-sm" />
      ...
      <div className="p-6 bg-gradient-to-b from-black via-[#2A1F3C] to-[#1A1F2C]">
        <div
          ...
          <div className="space-y-4 animate-fade-in">
            {scene.choices.map((choice: Choice, index: number) => (
              <Button
                ...
                className="w-full justify-start bg-black/50 text-[#9b87f5] hover:bg-[#9b87f5] hover:text-white transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-[#9b87f5]/50 border border-[#9b87f5]/20"
                variant="outline"
              >
                {choice.text}
              </Button>
